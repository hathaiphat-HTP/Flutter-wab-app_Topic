...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Pantip",style: TextStyle(fontSize:20,fontFamily:'Prompt',fontWeight: FontWeight.bold,color: Colors.purple[800])),
      ),
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              "ลงชื่อเข้าใช้งาน",
              style: TextStyle(fontSize:25,fontFamily:'Prompt',fontWeight: FontWeight.bold,color: Colors.purple[800]),
            ),
            SizedBox(
              height: 10,
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.purple, // เปลี่ยนสีพื้นหลังตามที่ต้องการ
                ),
            ...
            Row(
              ...
              children: [
                TextButton(
                    ...
                    child: Text("Register",style: TextStyle(color: Colors.purple[800]),)),
